...
import '../styles/About_Docx.css'; 
import DocxIcon from '../images/docxIcon.svg'; 

const DocxContent = () => {
    return (
        <div className="docx-content-container"> {/* 부모 컨테이너 */}
            <div className="content-detail">
                <h1>ABOUT DOCX</h1>
                <div className="icon-paragraph-group-docx">
                    <img src={DocxIcon} alt="DOCX Icon" className="Docx-icon" />
            ...
            <div className="next-button-docx">
